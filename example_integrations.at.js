...
question("what is Alan (AI|Platform|)", (p) => {
  p.play(
    "Alan (AI|Platform) is a platform that will allow you to voice enable any application. Be it mobile app on iOS or Android, or a web page."
  );
});

question("what (platforms|SDK|frameworks) are supported", (p) => {
  p.play(
    "Alan (AI|Platform) supports native iOS, Android, and Web applications. As well as Flutter, Ionic and many other popular frameworks."
  );
});